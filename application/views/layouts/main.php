...
<html>
    <head>
        ...
        <title><?= (!empty($title) ? $title: "dashboard"); ?> | RecrutSoftware</title>
        ...
        <div class="wrapper">
            <header class="main-header">
                ...
                <a href="" class="logo">
                    ...
                    <span class="logo-mini">RECRUTSOFT</span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg">RECRUTSOFT</span>
                </a>
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
						...
						<li>
                            <a href="#">
                                <i class="fa fa-cubes"></i> <span>Offres d'emploi</span>
                            </a>
                            <ul class="treeview-menu">
								<li class="active">
                                    <a href="<?php echo site_url('offres/add');?>"><i class="fa fa-plus"></i> Creer une offre</a>
                                </li>
								<li>
                                    <a href="<?php echo site_url('offres/index');?>"><i class="fa fa-list-ul"></i> Listing offres</a>
                                </li>
							</ul>
                        </li>
						...
						<li>
                            <a href="#">
                                <i class="fa fa-address-book"></i> <span>Candidats</span>
                            </a>
                            <ul class="treeview-menu">
								<li class="active">
                                    <a href="<?php echo site_url('candidats/add');?>"><i class="fa fa-plus"></i> Creer un candidat</a>
                                </li>
								<li>
                                    <a href="<?php echo site_url('candidats/index');?>"><i class="fa fa-list-ul"></i> Listing candidats</a>
                                </li>
							</ul>
                        </li>
                        ...
                        <li>
                            <a href="#">
                                <i class="fa fa-address-book"></i> <span>Demandes</span>
                            </a>
                            <ul class="treeview-menu">
                                <li class="active">
                                    <a href="<?php echo site_url('demandes/add');?>"><i class="fa fa-plus"></i> Creer une demande</a>
                                </li>
                                <li>
                                    <a href="<?php echo site_url('demandes/index');?>"><i class="fa fa-list-ul"></i> Demandes Listing</a>
                                </li>
