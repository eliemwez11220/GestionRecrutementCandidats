...
<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('candidats/edit/'.$candidat['candidat_id']); ?>
			<div class="box-body">
                <div class="row clearfix">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="nom_complet"
                                   value="<?php echo ($this->input->post('nom_complet'))?$this->input->post('nom_complet'):$candidat['nom_complet']; ?>" class="form-control" id="nom_complet" />
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="email" name="email" value="<?php echo ($this->input->post('email'))?$this->input->post('email'):$candidat['email']; ?>" class="form-control" id="email" />
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="niveau_etude" value="<?php echo ($this->input->post('niveau_etude'))?$this->input->post('niveau_etude'):$candidat['niveau_etude']; ?>" class="form-control"
                                   id="niveau_etude" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="lieu_naissance" value="<?php echo ($this->input->post('lieu_naissance'))?$this->input->post('lieu_naissance'):$candidat['lieu_naissance']; ?>" class="form-control" id="lieu_naissance" />
                        ...
                        <div class="form-group">
                            <input type="date" max="<?php echo $date_max_naissance; ?>" name="date_naissance" value="<?php echo ($this->input->post('date_naissance'))?$this->input->post('date_naissance'):$candidat['date_naissance']; ?>" class="form-control" id="date_naissance" />
                        ...
                        <div class="form-group">
                            <input type="text" name="matricule" value="<?php echo ($this->input->post('matricule'))?$this->input->post('matricule'):$candidat['matricule']; ?>" class="form-control" id="matricule" />
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <textarea name="adresse" class="form-control" id="adresse"><?php echo ($this->input->post('adresse'))?$this->input->post('adresse'):$candidat['adresse']; ?></textarea>
                        </div>
                    </div>
                    <div class="col-md-6">
