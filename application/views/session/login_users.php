...
<head>
    ...
    <title><?= $title ? $title : 'Bienvenue' ?> | RecrutSoftware Applicattion !</title>
            ...
            <div class="hpanel">
                <div class="panel-body">
                    <div class="text-center m-b-md custom-login">
                        ...
                        <?php } else { ?>
                            <b>RecrutSoftware Application</b>!
                ...
                <div class="col-sm-6">
                    <div class="float-left text-left">
                        ...
                        <img src="<?= base_url(); ?>global/img/logo/educaza100.png"
                            ...
                            | <a href="https://congoagile.com" style="background-color: transparent; color: blue; font-weight: bold;">RecrutSoftware Application</a>
                        </span>
                    </div>
                </div>
                <div class="col-sm-6" >
