    ...
    <div class="col-md-12">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Creation d'une demande</h3>
            </div>
            <?php echo form_open('demandes/add'); ?>
            <div class="box-body">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input list="brow_offre" name="offre_sid" class="form-control text-capitalize"
                                   id="offre_sid" type="text" placeholder="Offre..." value="<?= set_value('offre_sid'); ?>">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="date" name="date_postule"
                                   value="<?php echo $this->input->post('date_postule'); ?>"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="date" name="date_validation"
                                   value="<?php echo $this->input->post('date_validation'); ?>"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="nom_dossier"
                                   value="<?php echo $this->input->post('nom_dossier'); ?>"
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <textarea name="observation_demande" class="form-control"
                                      id="observation_demande"><?php echo $this->input->post('observation_demande'); ?></textarea>
                        </div>
                    </div>
                </div>
            </div>
